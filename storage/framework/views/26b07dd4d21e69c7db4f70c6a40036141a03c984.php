...
$src = "";
	if($record->question_type!='video' && $record->question_type!='audio') { ?>
        <img src="<?php echo e(EXAM_UPLOADS.$record->question_file); ?>" height="90" width="90"/> 
    <?php } elseif($record->question_type == 'video') { 
			...
			<audio controls class="audio-controls">
        	  	<source src="<?php echo e($src); ?>" type="audio/ogg">
          		<source src="<?php echo e($src); ?>" type="audio/mpeg">
        	</audio>
