 ...
 ?>
	<div id="wrapper" class="<?php echo e($class); ?>">
		...
		<aside class="left-sidebar">			<div class="collapse navbar-collapse navbar-ex1-collapse">				<ul class="nav navbar-nav side-nav">					<li <?php echo e(isActive($active_class, 'dashboard')); ?>> 
					...
					<a data-toggle="collapse" data-target="#master"><i class="fa fa-hashtag"></i> 
					<?php echo e(getPhrase('master')); ?> </a> 
					
					<ul id="master" class="collapse sidemenu-dropdown">
							<li><a href="<?php echo e(URL_DEPARTMENT_LIST); ?>"> <i class="fa fa-list"></i><?php echo e(getPhrase('department')); ?></a></li>
							<li><a href="<?php echo e(URL_SECTION_LIST); ?>"> <i class="fa fa-list"></i><?php echo e(getPhrase('section')); ?></a></li>
					...
					<ul id="lms" class="collapse sidemenu-dropdown">
						...
						<a href="<?php echo e(URL_RESUME_TEMPLATES); ?>" ><i class="fa fa-file-image-o" aria-hidden="true"></i>
					<?php echo e(getPhrase('resume_templates')); ?> </a> 
					...
					<li <?php echo e(isActive($active_class, 'pages')); ?> > 
						<a href="<?php echo e(URL_PAGES); ?>" ><i class="fa fa-book" aria-hidden="true"></i> 
					<?php echo e(getPhrase('pages')); ?> </a> 
