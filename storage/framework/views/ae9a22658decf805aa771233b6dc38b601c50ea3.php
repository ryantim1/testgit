	...
	<div class="crearfix selected-questions-details">
		...
		<span class="pull-left" ng-if="is_have_section==0"><?php echo e(getPhrase('saved_questions')); ?> ({{savedQuestions.length}})</span>
		<span class="pull-left" ng-if="is_have_section==1">Total Sections ({{keys.length}})
 
		</span>

		<span class="pull-right"><?php echo e(getPhrase('total_marks')); ?>: {{ totalMarks }}</span>
