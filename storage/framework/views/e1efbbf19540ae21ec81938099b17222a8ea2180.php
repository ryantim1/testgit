				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							<a href="<?php echo e(URL_COUPONS_ADD); ?>" class="btn  btn-primary button" ><?php echo e(getPhrase('create')); ?></a>
						</div>
						...
						<table class="table table-striped table-bordered datatable" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th><?php echo e(getPhrase('minimum_bill')); ?></th>
									<th><?php echo e(getPhrase('maximum_discount')); ?></th>
									<th><?php echo e(getPhrase('limit')); ?></th>
...
<?php $__env->startSection('footer_scripts'); ?>
 ...
 <?php echo $__env->make('common.datatables', array('route'=>URL_COUPONS_GETLIST, 'route_as_url' => TRUE), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
